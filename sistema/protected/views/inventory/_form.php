...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'list_price',array('size'=>10,'maxlength'=>10)); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'new_quantity'); ?>
		<?php echo $form->textField($model,'new_quantity',array('size'=>10,'maxlength'=>10)); ?>
		<?php echo $form->error($model,'new_quantity'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'description_purchase'); ?>
		<?php echo $form->textArea($model,'description_purchase',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'description_purchase'); ?>
	</div>
