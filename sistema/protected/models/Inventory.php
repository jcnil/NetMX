...
class Inventory extends CActiveRecord
{
	...
	public function validaNewQuantity($attribute){
		if($this->new_quantity <= $this->quantity){
			$this->addError($attribute,'La nueva cantidad de producto es menor o igual a la cantidad de producto');
		}
	}
	...
	public function rules()
	{
		...
		return array(
			array('name, description, type_product, code, price, quantity, warranty, list_price, lot_id, location, date_inventory', 'required'),
			...
			array('new_quantity','validaNewQuantity'),
